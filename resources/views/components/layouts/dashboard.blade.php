                        ...
                        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden lg:sticky lg:top-20">
                            ...
                            <nav class="py-2">
                                ...
                                <a href="{{ route('user.balance') }}" 
                                   class="flex items-center px-4 py-3 text-sm font-medium transition-colors {{ request()->routeIs('user.balance') ? 'text-green-600 bg-green-50 border-l-4 border-green-600' : 'text-gray-700 hover:bg-gray-50 border-l-4 border-transparent' }}">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
